# decompile by uzair khan
# source code by uzair khan
...
logo = '\n\n\x1b[1;92m\n╔╦╗╔══╗╔══╗╔══╗╔═╗
 = '\n\n\x1b[1;93m\║║║╠══║║╔╗║╚║║╝║╬║
 = '\n\n\x1b[1;98m\║║║║══╣║╠╣║╔║║╗║╗╣
 = '\n\n\x1b[1;94m\╚═╝╚══╝╚╝╚╝╚══╝╚╩╝_____\    _________  \n  /  _  \\   \\_   ___ \\ \n /  /_\[1;93m uzair khan   |    [1;97m-----------------------------------------\n   Author   : uzair khan\n   Github   : https://github.com/uzairkhan786\n   Youtube  : khan\n----------------------------------------------\n             \x1b[1;92mFREE MODE ACTIVATED\n\x1b[1;97m------------------------------------------------\nKnow me from my character\n------------------------------------------------ '
...
def reg():
    ...
    print ''
    print ''
    print '\x1b[1;92m  [Connected With uzair Servers]'
    print ''
...
def reg2():
    ...
    print ''
    print '\x1b[1;96m '
    print ' \xe2\x80\xa2 THIS TOOL IS COMPLETELY CODED BY uzair khan \xe2\x80\xa2 '
    time.sleep(5)
    login()
...
def menu():
    ...
    print ''
    print 47 * '-'
    print ' \x1b[1;91m          may funiya bhola do ga'
    print '         '
    print '\x1b[1;97m'
    print 47 * '-'
    print ''
...
def menu_option():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/uzairkhan')
        menu()
    elif select == '3':
